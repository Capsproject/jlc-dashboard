...
@Component({
  ...
  template: `<nav
    ...
    class="scrollbar-thumb-rounded scrollbar-track-rounded hidden border h-full drop-shadow-lg flex-col justify-between overflow-auto bg-background pt-3 transition-all duration-300 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-card lg:flex"
  >
    <div class="px-4">
      <!-- Logo -->
